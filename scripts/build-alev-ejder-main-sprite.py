#!/usr/bin/env python3
"""Alev Ejderi ana ekran: alev_ejderi_anaekran.mp4 (yeşil) -> seamless WebP sprite."""
...
VIDEO = os.path.join(ROOT, "hero", "flame_dragon", "alev_ejderi_anaekran.mp4")
OUT_DIR = os.path.join(ROOT, "hero", "flame_dragon", "sprite")
SHEET_WEBP = os.path.join(OUT_DIR, "alev-ejder-main.webp")
...
def write_manifest(main: dict) -> None:
    ...
    combined = {
        "version": 5,
        "base": "hero/flame_dragon/sprite/",
        "sheet": store.get("sheet", "alev-ejder-idle.webp"),
    ...
    js = "/* AUTO: scripts/build-alev-ejder-main-sprite.py */\n"
    js += "window.NOVA_ALEV_EJDER_SPRITE_BASE=" + json.dumps(combined["base"]) + ";\n"
    js += "window.NOVA_ALEV_EJDER_SPRITE_MANIFEST = "
