#!/usr/bin/env python3
"""Bilge Baykuş — vitrin, ana ekran, DOĞRU -> seamless WebP sprite sheets."""
...
HERO_DIR = os.path.join(ROOT, "hero", "bilge_baykus")
OUT_DIR = os.path.join(HERO_DIR, "sprite")
TRUE_DIR = os.path.join(OUT_DIR, "true")
MANIFEST_JS = os.path.join(ROOT, "js", "ui", "012aq-nova-bilge-baykus-sprite-manifest.js")
TRUE_MANIFEST_JS = os.path.join(ROOT, "js", "ui", "012as-nova-bilge-baykus-true-manifest.js")
...
def main() -> int:
    ...
    if true_only:
        true_clip = build_true_sheet(
            TRUE_VIDEO,
            os.path.join(TRUE_DIR, "bilge-baykus-true-dogru.webp"),
        )
        true_root = {
            "version": 1,
            "base": "hero/bilge_baykus/sprite/true/",
            "scale": {"sp": 1},
            "holdMs": 520,
            "clips": [true_clip],
        }
        write_js(
            TRUE_MANIFEST_JS,
            "/* AUTO: scripts/build-bilge-baykus-sprites.py */",
            [
                'window.NOVA_BILGE_BAYKUS_TRUE_BASE="hero/bilge_baykus/sprite/true/";',
                "window.NOVA_BILGE_BAYKUS_TRUE_MANIFEST = "
    ...
    if idle_only:
        ...
        idle = build_loop_sheet(
            VITRIN_VIDEO,
            os.path.join(OUT_DIR, "bilge-baykus-idle.webp"),
            target_fps=12,
            max_frames=None,
            blend_frames=0,
            target_h=290,
        ...
        if os.path.isfile(manifest_path):
            ...
            combined = {"version": 1, "base": "hero/bilge_baykus/sprite/", "scale": {"store": 1.12, "detail": 1.28, "main": 1.42}}
        ...
        write_js(
            ...
            "/* AUTO: scripts/build-bilge-baykus-sprites.py */",
            [
                'window.NOVA_BILGE_BAYKUS_SPRITE_BASE="hero/bilge_baykus/sprite/";',
                "window.NOVA_BILGE_BAYKUS_SPRITE_MANIFEST = "
